...
//Checks for file uploads and size
...
//To check that atleast one of the fields should be
// submitted
...
// For someone creating a job these are the rules that
...
//For someone searching for a specific job
